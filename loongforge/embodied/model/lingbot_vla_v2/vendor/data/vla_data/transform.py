...
from loongforge.embodied.model.lingbot_vla_v2.vendor.utils import logging as logging_utils
        ...
        for key, value in data.items():
            if key in self.norm_stats:
                ...
                if norm_type == "meanstd":
                    ...
                    raise ValueError(
                        f"Unknown normalization type: {norm_type}. Supported types "
                        "are 'meanstd', 'minmax', 'sincos', and 'identity'."
                    )
        ...
        for key, value in data.items():
            if key in self.norm_stats:
                ...
                if norm_type == "meanstd":
                    ...
                    raise ValueError(
                        f"Unknown normalization type: {norm_type}. Supported types are "
                        "'meanstd', 'minmax', 'sincos', and 'identity'."
                    )
