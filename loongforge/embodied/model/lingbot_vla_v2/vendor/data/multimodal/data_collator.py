...
class OmniSequenceShardCollator(DataCollator):
    ...
    def __post_init__(self):
        ...
        # If rmpad_with_pos_ids, attention_mask is set to 1 for flash attention.
        # Refer to the Llama attention-mask handling in Hugging Face
        # Transformers (modeling_llama.py#L641).
...
class OmniDataCollatorWithPadding(DataCollator):
    ...
    Example:
        >>> from loongforge.embodied.model.lingbot_vla_v2.vendor.data import OmniDataCollatorWithPadding
...
class OmniDataCollatorWithPacking(DataCollator):
    ...
    Args:
        ...
        concat_features: features to concat in batch.
    Example:
        >>> from loongforge.embodied.model.lingbot_vla_v2.vendor.data import OmniDataCollatorWithPacking
