...
except ImportError:  # transformers >= 5.0 moved it to transformers.initialization
...
def get_loader(model_config, force_use_huggingface):
    ...
    if not force_use_huggingface:
        ...
        if model_arch in model_registry.supported_models:
            # <class 'veomni.models.transformers.qwen2_vl.modeling_qwen2_vl.Qwen2VLForConditionalGeneration'>
