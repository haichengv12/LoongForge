...
class Qwen2_5_VLVisionAttention(nn.Module):  # pylint: disable=invalid-name
    """Vendor interface."""
        ...
        **kwargs,
        ...
        if self.config._attn_implementation == "flash_attention_2":
            ...
            if key_states.dtype == torch.float32:
                out_fp32_atten = True
                query_states, key_states, value_states = query_states.to(
                    torch.bfloat16), key_states.to(torch.bfloat16), value_states.to(torch.bfloat16)
...
class Qwen2_5_VLVisionBlock(GradientCheckpointingLayer):  # pylint: disable=invalid-name
    """Vendor interface."""
...
class Qwen2_5_VLPreTrainedModel(PreTrainedModel):  # pylint: disable=invalid-name
    """Vendor interface."""
...
class Qwen2_5_VLDecoderLayer(GradientCheckpointingLayer):  # pylint: disable=invalid-name
    """Vendor interface."""
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if compute_kqv:
            ...
            raise ValueError(
                ...
                f"output_atten={output_atten} with Qwen2_5_VLDecoderLayer in LingBot-VLA"
            )


class Qwen2_5_VLTextModel(Qwen2_5_VLPreTrainedModel):  # pylint: disable=invalid-name
    """Vendor interface."""
...
class Qwen2_5_VLForConditionalGeneration(Qwen2_5_VLPreTrainedModel, GenerationMixin):  # pylint: disable=invalid-name
    """Vendor interface."""
